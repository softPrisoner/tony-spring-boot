package com.rainbow.tony.activiti.aop;

import com.alibaba.fastjson.JSON;
import com.rainbow.tony.activiti.annotation.SystemLog;
import com.rainbow.tony.activiti.common.BaseEntity;
...
public class SystemLogAop {
    ...
    // 业务日志切点
    @Pointcut("execution(* com.rainbow.tony.*.controller.*.*(..))")
    ...
    public Object doController(ProceedingJoinPoint point) throws Throwable {
        Thread.currentThread().setName(MixUtils.getUUID());
